...
import { useGetBuyerQuery, useGetBuyersQuery, useUpdateCanLoginMutation } from "../../services/api";
...
const AdminBuyers = () => {
    ...
    const { data: response, isLoading, error } = useGetBuyersQuery({
        page,
        limit,
        searchQuery,
        sortField,
    ...
    const { data: buyerDetails } = useGetBuyerQuery(selectedBuyerId || "", {
        skip: !selectedBuyerId
    });
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <h1 className="text-2xl font-bold text-gray-800 mb-6">Gestion des Vendeurs</h1>
            ...
            >
                {buyerDetails?.data && <BuyerDetails buyer={buyerDetails.data} />}
            </Modal>
        </div>
    );
};
