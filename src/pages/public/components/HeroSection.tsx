        ...
        <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black">
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-4 text-center">
                ...
                <p className="text-amber-500/80 text-sm md:text-base tracking-[0.25em] uppercase mb-8">
                    {t('Cabinet digital de développement spirituel', 'Digital Spiritual Development Practice')}
                </p>

                <p className="max-w-2xl mx-auto text-lg md:text-xl text-gray-300/90 font-light leading-relaxed mb-12">
                    {t(
                        "Guérir les maux de l'âme et accompagner chacun dans un voyage profond de connaissance de soi.",
                        "Healing the wounds of the soul and guiding each person on a deep journey of self-discovery."
                    )}
                </p>
