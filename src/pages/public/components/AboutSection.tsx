...
const AboutSection = () => {
  ...
  const description = aboutSection ? (lang === 'fr' ? (aboutSection.descriptionFr ?? aboutSection.description_fr) : (aboutSection.descriptionEn ?? aboutSection.description_en)) : t("Physicien micro-vibratoire et fondateur du cabinet Triskeloum ainsi que de l'association Akpé Fondation, j'accompagne les êtres dans leur chemin de transformation intérieure et de réalisation spirituelle.", "Micro-vibratory physicist and founder of Triskeloum as well as the Akpé Foundation, I guide beings on their path of inner transformation and spiritual realization.");
  ...
  const team = (teamData.length ? teamData.map((member: any) => ({
    ...
    { name: 'Taj Rasmoon', roleFr: 'PDG Triskeloum - Maître spirituel', roleEn: 'CEO Triskeloum - Spiritual Master' },
