                ...
                <div className="relative bg-white rounded-lg shadow-xl max-w-md w-full">
                    ...
                    <div className="flex items-center justify-between p-6 border-b border-gray-200">
                        <div className="flex items-center gap-3">
                            <div className={`flex items-center justify-center w-12 h-12 rounded-full ${isDangerous ? 'bg-red-100' : 'bg-blue-100'}`}>
                                <ExclamationTriangleIcon className={`w-6 h-6 ${isDangerous ? 'text-red-600' : 'text-blue-600'}`} />
                            </div>
