...
const ServiceCard = ({ icon, title, description, features }: any) => (
    <div className="group bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
        ...
        <button className="mt-8 w-full bg-gray-900 text-white py-3 rounded-full font-semibold hover:bg-green-800 transition-colors duration-300 group-hover:bg-gradient-to-r group-hover:from-green-600 group-hover:to-blue-600">
            En savoir plus
        </button>
    </div>
);
